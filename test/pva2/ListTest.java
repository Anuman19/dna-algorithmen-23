...
public class ListTest {
    ...
    // It would be important to separate the basicTest and testIterator into different tests to test the different functions!
    // e.g. testAdd, testSet, etc.
    // these grouped tests make it hard to test different cases and methods.
